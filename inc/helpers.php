...
/**
 * Return a normalized stock state for theme UI classes.
 */
function devhub_get_product_stock_state(WC_Product $product): string
{
    return $product->is_in_stock() ? 'in' : 'out';
}

/**
 * Return the stock message text generated by WooCommerce.
 * This respects WooCommerce inventory display settings.
 */
function devhub_get_product_stock_text(WC_Product $product): string
{
    $stock_html = function_exists('wc_get_stock_html') ? wc_get_stock_html($product) : '';
    $stock_text = trim(wp_strip_all_tags((string) $stock_html));
    ...
    return $product->is_in_stock()
        ? __('In stock', 'devicehub-theme')
        : __('Out of stock', 'devicehub-theme');
}
...
function devhub_render_product_card(WC_Product $product, string $img_override = ''): void
{
    ...
    <div class="devhub-product-card" data-brands="<?php echo esc_attr($brand_slugs); ?>">
        ...
        <span class="devhub-product-card__stock devhub-product-card__stock--<?php echo esc_attr(devhub_get_product_stock_state($product)); ?>">
            <?php echo esc_html(devhub_get_product_stock_text($product)); ?>
        </span>
